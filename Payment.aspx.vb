'post_values.Add("x_login", "594tNyA4")  ' your login ID
'post_values.Add("x_tran_key", "2vN6s8eN96Z85X5k")  ' your transaction key
Imports System.Net
Imports System.IO
...
Partial Class Payment
    ...
    Protected Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        ' get string
        Dim tbValue As String = tb1.Text
        ' name/value pairs
        ...
        post_values.Add("x_card_num", tbValue)
